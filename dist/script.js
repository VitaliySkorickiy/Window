...
var images = function images() {
  var imgPopup = document.createElement('div'),
      ...
      bigImage = document.createElement('img'); // создаем popup

  imgPopup.classList.add('popup'); // в popup помещаем весь блок
...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    var trigger = document.querySelectorAll(triggerSelector),
        ...
        scroll = calcScroll(); //  открыли МО ( клик по каждому айтему из HTML коллекции querySelectorAll)
...
"use strict";
__webpack_require__.r(__webpack_exports__);
// передаём в аргументы , куда будет внедрён таймер и время таймера
